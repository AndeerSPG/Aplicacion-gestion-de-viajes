...
public class viajero extends user{
	...
	/*public RideSolicitado ReservarViaje(int rideNumberViaje, String origen, String destino, Date fecha, int asientos,
			double precio, Driver conductor, viajero usuario, int numPlazasSeleccionadas) {
